/**
 * Layout Topo Global — ícones e metadados dos botões (espelho do Top).
 */
(function () {
  const NS = (window.CustomiseNS = window.CustomiseNS || {});
  if (NS.TopoGlobalMeta) return;

  const RIGHT_ACTION_META = Object.freeze({
    downloadBtn: {
      label: "Downloads",
  ...
  NS.TopoGlobalMeta = { RIGHT_ACTION_META, NAV_ICON };
})();
